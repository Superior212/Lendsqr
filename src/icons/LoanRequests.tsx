...
function LoanRequests(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 18 22" fill="none" {...props}>
      <g clipPath="url(#prefix__clip0_97297_805)">
        <path
      ...
      <g clipPath="url(#prefix__clip1_97297_805)" fill="#213F7D">
        <path
          opacity={0.4}
      ...
      <defs>
        <clipPath id="prefix__clip0_97297_805">
          <path fill="#fff" transform="translate(0 6)" d="M0 0h18v16H0z" />
        </clipPath>
        <clipPath id="prefix__clip1_97297_805">
...
const MemoLoanRequests = React.memo(LoanRequests);
export default MemoLoanRequests;
